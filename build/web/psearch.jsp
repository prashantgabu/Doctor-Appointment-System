        ...
        <div class="row">
            <%
                ...
                if (request.getParameter("btn") != null) {
                    ...
                    q = "Select d.*,p.*,s.* from doctor_register d, doctor_profile p, schedule s where d.doctor_id=p.doctor_id and d.fname like'%" + dname + "%'";
                } else {
                    
                    String dept=request.getParameter("dept");
                    
                    q = "Select d.*,p.* from doctor_register d, doctor_profile p where d.doctor_id=p.doctor_id and p.specialist='" + dept + "'";
                }
            ...
            <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    <div class="img mb-4" style="background-image: url(propic/<%=propic%>);"></div>

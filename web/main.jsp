...
<form action="vsearch.jsp" method="get">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services d-block text-center">
                    <div class="icon d-flex justify-content-center align-items-center">
                        <span><img src="backgrounds/ortho.jpg" height="120px" width="120px"></span>
                    </div>
                    <div class="media-body p-2 mt-3">
            ...
            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services d-block text-center">
                    <div class="icon d-flex justify-content-center align-items-center">
                        <span><img src="backgrounds/psy.jpg" height="100px" style="border-radius: 50%;" width="100px"></span>
                    </div>
                    <div class="media-body p-2 mt-3">
